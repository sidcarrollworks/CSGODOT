...
|---|---|---|---|---|---|---|---|
| `weapon_glock` | Glock-18 | `glock18` | `weapon_pist_glock18.gltf` | `weapon_pist_glock18_mag.gltf` | `pistol/pistol_glock18` (8) | `pistol/pistol_glock` (9) | `glock18` |
| `weapon_hkp2000` | P2000 | `hkp2000` | `weapon_pist_hkp2000.gltf` | `weapon_pist_hkp2000_mag.gltf` | `pistol/pistol_hkp2000` (8) | `pistol/pistol_hkp2000` (9) | `hkp2000` |
| `weapon_usp_silencer` | USP-S (no silencer) | `usp_silencer` | `weapon_pist_usp_silencer.gltf` | `weapon_pist_usp_silencer_mag.gltf` | `pistol/_default_pistol` (11) | `pistol/pistol_usp` (11) | `usp_silencer` |
| `weapon_elite` | Dual Berettas | `elite` | `weapon_pist_elite.gltf` | `weapon_pist_elite_mag.gltf` | `pistol/pistol_elite` (11) | `pistol/pistol_elite` (10) | `elite` |
| `weapon_p250` | P250 | `p250` | `weapon_pist_p250.gltf` | `weapon_pist_p250_mag.gltf` | `pistol/pistol_p250` (8) | `pistol/pistol_p250` (9) | `p250` |
| `weapon_tec9` | Tec-9 | `tec9` | `weapon_pist_tec9.gltf` | `weapon_pist_tec9_mag.gltf` | `pistol/pistol_tec9` (6) | `pistol/pistol_tec9` (7) | `tec9` |
| `weapon_fiveseven` | Five-SeveN | `fiveseven` | `weapon_pist_fiveseven.gltf` | `weapon_pist_fiveseven_mag.gltf` | `pistol/pistol_fiveseven` (8) | `pistol/pistol_fiveseven` (9) | `fiveseven` |
| `weapon_cz75a` | CZ75 Auto | `cz75a` | `weapon_pist_cz75a.gltf` | `weapon_pist_cz75a_mag.gltf` | `pistol/pistol_cz75a` (11) | `pistol/pistol_cz75a` (16) | `cz75a` |
| `weapon_deagle` | Desert Eagle | `deagle` | `weapon_pist_deagle.gltf` | `weapon_pist_deagle_mag.gltf` | `pistol/pistol_deagle` (9) | `pistol/pistol_deagle` (9) | `deagle` |
| `weapon_revolver` | R8 Revolver | `revolver` | `weapon_pist_revolver.gltf` | - | `pistol/pistol_revolver` (17) | `pistol/pistol_revolver` (10) | `revolver` |
| `weapon_nova` | Nova | `nova` | `weapon_shot_nova.gltf` | - | `rifle/rifle_nova` (5) | `rifle/rifle_nova` (7) | `nova` |
| `weapon_xm1014` | XM1014 | `xm1014` | `weapon_shot_xm1014.gltf` | - | `rifle/rifle_xm1014` (6) | `rifle/rifle_xm1014` (7) | `xm1014` |
| `weapon_sawedoff` | Sawed-Off | `sawedoff` | `weapon_shot_sawedoff.gltf` | - | `rifle/rifle_sawedoff` (5) | `rifle/rifle_sawedoff` (7) | `sawedoff` |
| `weapon_mag7` | Mag-7 | `mag7` | `weapon_shot_mag7.gltf` | `weapon_shot_mag7_mag.gltf` | `rifle/rifle_mag7` (5) | `rifle/rifle_mag7` (7) | `mag7` |
| `weapon_mac10` | MAC-10 | `mac10` | `weapon_smg_mac10.gltf` | `weapon_smg_mac10_mag.gltf` | `rifle/rifle_mac10` (5) | `rifle/rifle_mac10` (7) | `mac10` |
| `weapon_mp9` | MP9 | `mp9` | `weapon_smg_mp9.gltf` | `weapon_smg_mp9_mag.gltf` | `rifle/rifle_mp9` (5) | `rifle/rifle_mp9` (7) | `mp9` |
| `weapon_mp7` | MP7 | `mp7` | `weapon_smg_mp7.gltf` | `weapon_smg_mp7_mag.gltf` | `rifle/rifle_mp7` (5) | `rifle/rifle_mp7` (7) | `mp7` |
| `weapon_mp5sd` | MP5-SD | `mp5sd` | `weapon_smg_mp5sd.gltf` | `weapon_smg_mp5sd_mag.gltf` | `rifle/rifle_mp5sd` (6) | `rifle/rifle_mp5sd` (9) | `mp5sd` |
| `weapon_ump45` | UMP-45 | `ump45` | `weapon_smg_ump45.gltf` | `weapon_smg_ump45_mag.gltf` | `rifle/rifle_ump45` (5) | `rifle/rifle_ump45` (7) | `ump45` |
| `weapon_p90` | P90 | `p90` | `weapon_smg_p90.gltf` | `weapon_smg_p90_mag.gltf` | `rifle/rifle_p90` (5) | `rifle/rifle_p90` (7) | `p90` |
| `weapon_bizon` | PP-Bizon | `bizon` | `weapon_smg_bizon.gltf` | `weapon_smg_bizon_mag.gltf` | `rifle/rifle_bizon` (7) | `rifle/rifle_bizon` (7) | `bizon` |
| `weapon_galilar` | Galil AR | `galilar` | `weapon_rif_galilar.gltf` | `weapon_rif_galilar_mag.gltf` | `rifle/rifle_galilar` (6) | `rifle/rifle_galilar` (7) | `galil` |
| `weapon_famas` | FAMAS | `famas` | `weapon_rif_famas.gltf` | `weapon_rif_famas_mag.gltf` | `rifle/rifle_famas` (5) | `rifle/rifle_famas` (7) | `famas` |
| `weapon_ak47` | AK-47 | `ak47` | `weapon_rif_ak47.gltf` | `weapon_rif_ak47_mag.gltf` | `rifle/rifle_ak` (11) | `rifle/rifle_ak` (7) | `ak47` |
| `weapon_m4a1` | M4A4 | `m4a4` | `weapon_rif_m4a4.gltf` | `weapon_rif_m4a4_mag.gltf` | `rifle/rifle_m4a4` (5) | `rifle/rifle_m4a4` (7) | `m4a4` |
| `weapon_m4a1_silencer` | M4A1-S (no silencer) | `m4a1_silencer` | `weapon_rif_m4a1_silencer.gltf` | `weapon_rif_m4a1_silencer_mag.gltf` | `rifle/_default_rifle` (7) | `rifle/rifle_m4a1_silencer` (9) | `m4a1_silencer` |
| `weapon_sg556` | SG 553 | `sg556` | `weapon_rif_sg556.gltf` | `weapon_rif_sg556_mag.gltf` | `rifle/rifle_sg556` (7) | `rifle/rifle_sg556` (7) | `sg556` |
| `weapon_aug` | AUG | `aug` | `weapon_rif_aug.gltf` | `weapon_rif_aug_mag.gltf` | `rifle/rifle_aug` (8) | `rifle/rifle_aug` (7) | `aug` |
| `weapon_m249` | M249 | `m249` | `weapon_mach_m249.gltf` | `weapon_mach_m249_mag.gltf` | `rifle/rifle_m249` (7) | `rifle/rifle_m249` (7) | `m249` |
| `weapon_negev` | Negev | `negev` | `weapon_mach_negev.gltf` | `weapon_mach_negev_mag.gltf` | `rifle/rifle_negev` (9) | `rifle/rifle_negev` (7) | `negev` |
| `weapon_ssg08` | SSG 08 | `ssg08` | `weapon_snip_ssg08.gltf` | `weapon_snip_ssg08_mag.gltf` | `rifle/rifle_ssg08` (10) | `rifle/rifle_ssg08` (7) | `ssg08` |
| `weapon_awp` | AWP | `awp` | `weapon_snip_awp.gltf` | `weapon_snip_awp_mag.gltf` | `rifle/rifle_awp` (5) | `rifle/rifle_awp` (7) | `awp` |
| `weapon_g3sg1` | G3SG1 | `g3sg1` | `weapon_snip_g3sg1.gltf` | `weapon_snip_g3sg1_mag.gltf` | `rifle/rifle_g3sg1` (5) | `rifle/rifle_g3sg1` (7) | `g3sg1` |
| `weapon_scar20` | SCAR-20 | `scar20` | `weapon_snip_scar20.gltf` | `weapon_snip_scar20_mag.gltf` | `rifle/rifle_scar20` (8) | `rifle/rifle_scar` (7) | `scar20` |
