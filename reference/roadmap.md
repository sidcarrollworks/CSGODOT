...
| 11 | Geometry flickering (the sky's brushes used as occluders) | **Done 2026-09-26:** the sky's brushes out of the occluders (`MapOccluders.NOT_DRAWN`) | Confirm with occlusion off; walk R3's spots; `run_tests.sh dust2` | R3 |
