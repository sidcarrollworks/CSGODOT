...
| 14 | Recoil on the AK-47 and M4A1-S only | *(done 2026-09-26)* The 15 more patterns already in `reference/spray_patterns/`, solved at load; a provisional kick for the rest | Spray the rest in CS2 (TODO L6); the R6 demo | 8 |
