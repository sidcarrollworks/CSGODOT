...
COMMAND="${1:-}"
case "$COMMAND" in
	list-map|list-weapons|map|physics|entities|nav|volumes|radar|surfaces|layers|sky|skybox|lightmaps|weapons|weapon-animations|weapon-data|equipment|hud|effects|characters|animgraphs|sounds|all) ;;
	*)
